...
@section('content')
    ...
    <div class="porlet-layout">
        <div class="porlet-left land mr-3">
            <div class="porlet-title title-land">Thông báo</div>
            <div class="porlet-post porlet-content">
                <div class="content-left mr-5">
                    <img src="{{ asset('images/thongbao.jpg') }}" alt="">
                </div>

                <div class="content-right">
                    <ul class="porlet-list">
                        @forelse($thongbao as $post)
                    ...
                    <a href="{{ url('blog/category/thong-bao') }}" class="read-more">> Xem tất cả</a>
                </div>
            </div>
        </div>
    </div>
