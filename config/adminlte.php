    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Category',
                    'url'  => 'blog_admin/categories',
                    'icon'    => 'fas fa-fw fa-archive',
                ],
                [
                    'text' => 'Add category',
                    'url'  => 'blog_admin/categories/add_category',
                    'icon'    => 'fas fa-fw fa-plus',
                ],
            ],
        ],
        [
            ...
            'submenu' => [
                [
                    'text' => 'Upload images',
                    'url'  => 'blog_admin/image_uploads',
                    'icon'    => 'fas fa-fw fa-images',
                ],
                [
                    'text' => 'Upload',
                    'url'  => 'blog_admin/image_uploads/upload',
                    'icon'    => 'fas fa-fw fa-plus',
                ],
            ],
        ],
